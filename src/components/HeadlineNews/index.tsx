  ...
  return (
    <Container>
      <Link to="noticia/id" className="headline-notice">
        ...
        />
        <h1>A Revolução 4.0 e seus Impactos na Indústria de Softwares</h1>
      </Link>
      <div className="headline-others">
        ...
        <Link to="noticia/id" className="headline-card">
          <img
            ...
            alt=""
          />
          <p>Seminário discute o efeito da pandemia em pessoas LGBTQI+</p>
        </Link>
        <Link to="noticia/id" className="headline-card">
          <img
            ...
            alt=""
          />
          <p>Restrições e cuidados para quem vai viajar durante a pandemia</p>
        </Link>
      </div>
    </Container>
  );
